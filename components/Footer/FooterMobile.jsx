  ...
  return (
    <>
      <div className='w-[98%] mx-auto bg-[#142740] block md:hidden py-1 px-1 rounded-t-md  text-[#FFFFFF] mt-12'>
        <div className='flex flex-col-reverse items-center gap-4'>
          ...
          <div className='w-full'>
            <button
              ...
              className='w-full bg-white h-9 rounded-xl'
            >
              <a className='text-gray-800'>بازشگت به بالا</a>
            </button>
          </div>
        </div>
        ...
        <Accordion
          className='!bg-[#142740] !outline-none  !text-white !border-none !shadow-none '
        ...
        >
          ...
          <AccordionDetails className='!text-white'>
            <div className='flex flex-col gap-4 pr-4 mt-4 mb-6 mr-6 border-r border-white border-opacity-40'>
              <a
                className='block text-xs !font-medium leading-[19px] !text-gray-200'
