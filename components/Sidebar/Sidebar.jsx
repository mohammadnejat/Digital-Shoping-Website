...
import UserLoginDropDownBasket from '../UserLoginDropdown/UserLoginDropDownBasket'
import UserLoginDropDownUser from '../UserLoginDropdown/UserLoginDropDownUser'
        ...
        <div>
          <div className='flex justify-center'>
            <div className='flex items-center gap-4'>
              ...
              <div className='p-[9px] border rounded-lg cursor-pointer md:block hidden'>
